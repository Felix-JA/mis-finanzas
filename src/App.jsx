...
export default function App(){
  ...
  // tx, goals, pagos, presupuestos, prestamos, deudas, patrimonio, isPro
  // vienen del hook useFirestoreData — ver más abajo
  ...
  // ── Datos de Firestore — todos los onSnapshot centralizados en el hook
  const {
    tx, setTx, txLoading,
    goals, setGoals,
    pagos, setPagos,
  ...
  // ── Exportar — delegado a exportUtils.js ─────────────────────────────────
  const exportCtx = {
    tx, now, MONTHS, MAIN_CATS, getCatInfo,
    isIngreso, isIngresoExtra, isAporteMeta, isSavingsLegacy,
    isDevolucion, isGasto, isMonth, COP,
    getSalarioDelMes, modoSalario, user,
    onDone: () => { setExportModal(false); setMenuOpen(false); },
  };
  function exportarCSV(soloMesActual=false){ exportCSVUtil(soloMesActual, exportCtx); }
  function exportarPDF(soloMesActual=false){ exportPDFUtil(soloMesActual, exportCtx); }
